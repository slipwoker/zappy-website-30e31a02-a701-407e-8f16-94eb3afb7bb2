    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "הודיה יודאיקה משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: '30e31a02-a701-407e-8f16-94eb3afb7bb2',
                    name: data.name || '',
                    email: data.email || '',
